  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 p-4">
      <motion.div
        ...
        className="relative z-10 w-full max-w-7xl mx-auto h-[95vh]"
      >
        <Card className="relative flex h-full bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl rounded-2xl overflow-hidden">
          {/* Decorative elements */}
