...
# Load BIP-39 English word list of 2048 words
WORDLIST = [
    ...
    "bad", "bag", "balance", "balcony", "ball", "bamboo", "banana", "banner", "bar", "barely",
    ...
    "boss", "both", "bottle", "bottom", "bounce", "box", "boy", "bracket", "brain", "brand",
    ...
    "catalog", "catch", "category", "cater", "chain", "chair", "chalk", "champion", "change", "chaos",
    ...
    "clay", "clean", "clear", "clinic", "clip", "clock", "clog", "close", "cloth", "cloud",
    ...
    "crumble", "crunch", "crush", "cry", "crystal", "cube", "cultural", "cup", "cupboard", "curious",
    "current", "curriculum", "custom", "cute", "cycle", "dad", "damage", "damp", "dance", "danger",
    "daring", "dash", "data", "date", "daughter", "dawn", "day", "deal", "debate", "debris",
    "decade", "december", "decide", "decline", "decorate", "decrease", "deer", "defense", "define", "defy",
    "degree", "delay", "deliver", "demand", "demise", "deny", "depart", "depend", "deposit", "depth",
    ...
    "drink", "drip", "drive", "drop", "drum", "dry", "duck", "dumb", "dump", "dune",
    "during", "dust", "dutch", "duty", "dynamic", "eager", "eagle", "early", "earn", "earth",
    ...
    "elite", "else", "email", "embed", "embody", "embrace", "emerge", "emotion", "employ", "empower",
    "empty", "enable", "enact", "end", "endless", "endorse", "enemy", "energy", "engine", "enhance",
    ...
    "essay", "essence", "estate", "eternal", "ethics", "event", "ever", "every", "evidence", "evil",
    "evolve", "exact", "example", "excess", "exchange", "excite", "exclude", "execute", "exercise", "exit",
    "exotic", "expand", "expect", "expire", "explain", "explore", "export", "expose", "express", "extend",
    "extra", "eye", "fabric", "face", "faculty", "fade", "faint", "faith", "fall", "false",
    "fame", "family", "famous", "fan", "fancy", "fantasy", "farm", "fashion", "fat", "fatal",
    "father", "fault", "favorite", "feature", "february", "federal", "fee", "feed", "feel", "female",
    ...
    "flip", "float", "flock", "floor", "flower", "fluid", "flush", "fly", "focus", "fold",
    "folk", "follow", "food", "foot", "force", "forest", "forget", "fork", "form", "fortune",
    ...
    "giggle", "ginger", "giraffe", "girl", "give", "glance", "glare", "glass", "glide", "global",
    "glove", "goat", "goddess", "gold", "good", "goose", "gorilla", "gospel", "gossip", "govern",
    "grab", "grace", "grain", "grant", "grape", "grass", "gravity", "great", "green", "grid",
    "grief", "grit", "grocery", "group", "grow", "grunt", "guard", "guess", "guide", "guilt",
    "guitar", "gun", "gym", "habit", "hair", "half", "hammer", "hamster", "hand", "happy",
    "harbor", "hard", "harmony", "hat", "hate", "have", "hawk", "hazard", "head", "health",
    "heart", "heavy", "helicopter", "hello", "helmet", "help", "hen", "hero", "high", "history",
    "hobby", "hockey", "hold", "hole", "holiday", "hollow", "home", "honey", "hood", "hope",
    "horn", "horror", "horse", "hospital", "host", "hotel", "hour", "hover", "how", "html",
    "hub", "huge", "human", "humble", "humor", "hundred", "hungry", "hunt", "hurry", "hurt",
    ...
    "include", "income", "increase", "index", "indicate", "indoor", "industry", "infant", "inflict", "influence",
    ...
    "invite", "involve", "iron", "island", "isolate", "issue", "item", "ivory", "jacket", "jail",
    "jam", "jar", "jazz", "jealous", "jeans", "jelly", "jewel", "job", "join", "joke",
    ...
    "latin", "laugh", "laundry", "law", "lawn", "lawsuit", "layer", "lazy", "leader", "leaf",
    ...
    "long", "loop", "lottery", "love", "loyal", "lucky", "luggage", "lumber", "lunar", "lunch",
    "luxury", "lyrics", "machine", "mad", "magic", "magnet", "maid", "mail", "main", "major",
    "make", "mammal", "man", "manage", "mandate", "mango", "manifest", "manual", "maple", "marble",
    "march", "margin", "market", "marriage", "mask", "mass", "master", "match", "material", "math",
    "matrix", "matter", "maximum", "may", "maybe", "mayor", "meadow", "mean", "measure", "meat",
    ...
    "neither", "nerve", "nest", "net", "network", "neutral", "never", "news", "next", "nice",
    ...
    "poem", "poet", "point", "polar", "pole", "police", "policy", "polygon", "pooch", "pool",
    "popular", "portion", "position", "positive", "possible", "post", "potato", "pottery", "poverty", "powder",
    ...
    "profit", "program", "project", "promote", "proof", "property", "prosper", "protect", "protein", "prove",
    ...
    "radar", "radio", "rail", "rain", "raise", "rally", "rampant", "ranch", "random", "range",
    ...
    "report", "require", "rescue", "search", "season", "seat", "second", "secret", "section", "security",
    "seed", "seek", "segment", "select", "sell", "send", "sense", "series", "service", "settle",
    "setup", "seven", "several", "sew", "sex", "shade", "shadow", "shake", "shallow", "share",
    ...
    "stomach", "stone", "stop", "storage", "store", "storm", "story", "stove", "strategy", "street",
    "strike", "strong", "struggle", "student", "stuff", "stumble", "style", "subject", "submit", "subway",
    "success", "such", "sudden", "suffer", "sugar", "suggest", "suit", "summer", "sun", "sunny",
    "sunset", "super", "supply", "supreme", "sure", "surface", "surge", "surprise", "surround", "survey",
    "suspect", "sustain", "swallow", "swamp", "swap", "swarm", "swear", "sweet", "swift", "swim",
    "swing", "switch", "sword", "symbol", "symptom", "syrup", "system", "table", "tackle", "tag",
    "tail", "talent", "talk", "tall", "tape", "target", "task", "taste", "tattoo", "taxi",
    "teach", "team", "tell", "ten", "tenant", "tennis", "tent", "term", "test", "text",
    "thank", "that", "theme", "then", "theory", "there", "they", "thing", "this", "thought",
    "three", "thrive", "throw", "thumb", "thunder", "ticket", "tide", "tiger", "tilt", "timber",
    "time", "tiny", "tip", "tired", "tissue", "title", "toast", "today", "toe", "together",
    ...
    "view", "village", "vintage", "violin", "virtual", "virus", "visa", "vital", "vitamin", "vivid",
    "vocal", "voice", "void", "volcano", "volume", "vote", "voyage", "wage", "wagon", "wait",
    "walk", "wall", "walnut", "warfare", "warm", "warrior", "wash", "wasp", "waste", "water",
    "wave", "way", "wealth", "weapon", "wear", "weasel", "weather", "web", "wedding", "week",
    ...
    "youth", "zebra", "zero", "zone", "zoo", "abacus", "abbey", "accent", "accountant", "acre", "adaptor", "adjustment", "admiral", "advocate",
    "aegis", "affluent", "aftermath", "agony", "airline", "albumin", "alchemist", "algebra", "alibi",
    "almond", "alpine", "amber", "ambush", "analogy", "anecdote", "anklet", "answerable", "antibody",
    "apricot", "aptitude", "architect", "archive", "arctic", "ardent", "arena", "aria", "armband",
    "armpit", "array", "articulate", "ashtray", "aside", "asparagus", "asterisk", "asthma", "atlas",
    "attic", "auditor", "augment", "authority", "autonomy", "avalanche", "avocado", "awaken", "axiom",
    "baboon", "backbone", "bacteria", "badminton", "baker", "banquet", "barge", "baritone", "barrel",
    "basement", "besiege", "betrayal", "bikini", "biome", "birthplace", "blazer", "bleach", "blizzard",
    "blockade", "bloom", "boomer", "bore", "boulevard", "bowtie", "brace", "bracket", "breach",
    "breakthrough", "breeze", "briefcase", "broccoli", "bronze", "buck", "buffer", "bully", "bureau",
    "burglar", "butterfly", "cabbage", "cable", "cactus", "cafe", "calendar", "campaign", "canister",
    "cannon", "cape", "capsule", "caravan", "carbohydrate", "cardinal", "cargo", "carve", "casualty",
